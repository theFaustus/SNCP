...
I have as much authority as the Pope, I just don't have as many people who believe it.
The main reason Santa is so jolly is because he knows where all the bad girls live.", "article_file_name" => "jirosa.pdf")), "publications" => array(array("publication_date" => "2015", "id" => 1, "titleList" => array(array("id" => 1, "title" => "Numarul 1"), array("id" => 2, "title" => "Numarul 2"))), array("publication_date" => "2015", "id" => 1, "titleList" => array(array("id" => 1, "title" => "Numarul 1"), array("id" => 2, "title" => "Numarul 2"))))]);
